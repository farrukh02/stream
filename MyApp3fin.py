...
max_value = max(result1, result2, result3, result4, result5, result6, result7, result8, result9, result10, result11, result12, result13, result14, result15)
secondMax = sorted(list([result1, result2, result3, result4, result5, result6, result7, result8, result9, result10, result11, result12, result13, result14, result15]))[-2]
...
if secondMax== result1: 
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Математик, иқтисодчӣ-математик, иқтисодчӣ, иқтисодчӣ-муҳосиб, муҳандис-иқтисодчӣ,Техник-математик, барномасоз, математики ҳисоббарор, техник-иқтисодчӣ, техник-нақшакаш, муҳосиб, нозири қарз, молиячӣ, оператори компютерӣ, кассир-назоратчӣ, кассир-оператори почта'
if secondMax== result2:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Муҳандиси технологияи кимиёвӣ, Техники технологияи кимиёвӣ, дорусоз, Дастгоҳчӣ, лаборанти кимиёвӣ, оператори панели идоракунӣ'
if secondMax== result3:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Биолог, агроном, ҷангалпарвар-муҳандис, агроном-хокшинос, муҳандисӣ ҳайвонот, байтор, Агроном-техник, техник-ҷангалпарвар, техники гидромелиоративй, мутахассиси соҳаи чорводорй, ёрдамчии бойтор, гулпарвар, боғбон, кабудизоркунанда, ҷангалбон, чорводор'
if secondMax== result4:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Биолог, гидрогеолог, геофизик, географ, харитакаш, муҳандис-геодезист, обуҳавосанҷ, гидролог, уқёнусшинос, гидрограф, Техник-топограф, техник-геодезист, Топограф, рассом-топограф'
if secondMax== result5:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Муҳандис-технолог, механик, бинокор, муҳандиси гармдиҳӣ, муҳандиси энергетикӣ, механики киштӣ, киштибон, ҳавонавард, Техник-технолог, механики бинокорӣ, муҳандиси гармдиҳӣ, киштисоз, механики киштӣ, бофанда, дӯзанда, пойафзолдӯз, кафшергар, таъмингар, хиштчин, андовачӣ, электрик, челогар, идоракунанда маторчӣ, ронанда'
if secondMax== result6:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Муҳандиси барқ, электрик, радиомеханик, Техник-электромеханик, электромонтёри техникӣ, радиотехник, Электромеханик, электромонтер, челонгар-электрик'
if secondMax== result7:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Нависанда, рӯзноманигор, муҳаррири адабиёти оммавӣ, китобдор, ислоҳкунандаи китобу маҷаллаҳо, муҳаррири техникӣ, ҳуруфчин, мошинист-стенограф'
if secondMax== result8:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Ҳуқуқшинос, муфаттиш, нозӣр, ҳуқуқшиноси кафолати бошуур, Милиса'
if secondMax== result9:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Таърихчӣ, бостоншинос, муаллими таърих'
if secondMax== result10:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Тарбиядиҳанда, профессор, муаллими фан, Мактаби ибтидоӣ, Муаллими боғча, муаллими синфҳои ибтидоӣ, муаллими фан, устои омузишгоҳи касбй-техникй, тарбиятгар'
if secondMax== result11:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Духтур, дастёри духтур, ҳамшира, Санитар'
if secondMax== result12:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Молшинос, тарҷумон, фурӯшанда, назоратчӣ-кассир, пешхизмат, барандаи экскурсия, роҳнамо, стюардесса'
if secondMax== result13:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Ҳарбӣ, устоди варзиш'
if secondMax== result14:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Композитор, дирижер, навозанда-вокалист, режиссери опера, балет, драма, театри лӯхтак, эстрада, актёри театр ва кино, Дирижер, навозанда, режиссер'
if secondMax== result15:
    result2 = 'Мо ба шумо тавсия медиҳем, ки дар ҶОИ ДУЮМ касбҳои зеринро баррасӣ кунед: Меъмор, рассом, ҳайкалтарош, дизайнери графикӣ, санъатшинос, рассоми санъат, дизайнери мӯд, техник-меъмор, ороишгар, рассом-барқароркунанда, техник-тарроҳ, тарҳкаш, Заргар, пармагари булӯр, дуредгари нодиракор, сикказан, суфтакунандаи рангуборкунии чинй, кандакор, барқароркунанда, бинокор, суратгир, сартарош'    
